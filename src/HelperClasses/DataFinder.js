...
export default class DataHelper {
    ...
    /**
     * Gets and returns all contest updates and announcements
     * @returns {Object[][]|null} - Returns array of all context announcements
     */
    static getAllAnouncements() {
        //Implement Logic Here
        return SampleAnnouncements;
    }

    /**
     * Gets and returns all stocks/tickers and information
     * @returns {Object[][]|null} - Returns array of all stocks (Ticker, price, change, percentageChange)
     */
    static getAllStocks() {
        //Implement Logic Here
        return sampleStockWidgetData;
    }

    /**
     * Gets and returns all orders on the order book for a specific ticker
     * @param {string} ticker ticker of stock to be searched
     * @returns {Object[][]|null} - Returns array of all orders for specific stock
     */
    static getStockOrders(ticker) {
        return SampleOrderBookData.find(
    ...
    /**
     * Takes in API key, and gets then returns the open position information for that team
     * @param {string} APIKey - inputted key of user
     * @returns {Object[][]} - Returns array of all open positions
     */
    static getPositionData(APIKey) {
        return samplePnLData;
    }
}